...
if(isset($_GET['id']))
{
	$q=mysql_query("Select * from post_article 
			where sha1(post_id)='".$_GET['id']."'");
...
if(isset($_POST["button"]))
{
	...
	$skrg=date("Y-m-d");
	$rs=mysql_query("Update post_article SET `title`='".$_POST['judul']."',`featurephoto`='".$_POST['photo']."', `post_entry`='".$_POST['editor1']."' Where sha1(post_id)='".$_GET['id']."'");
