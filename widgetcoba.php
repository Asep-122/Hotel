    ...
    custom_theme_widget: 'recaptcha_widget'
		...
		<form action="#" method="post" id="myform">
            ...
            <label>Provinsi</label>
				<select name="provinsi" class="required">
					<option value="">- please select -</option>
                    <?php
...
//	$q=mysql_query("Select * from reservations Where resv_date between '".$_POST['tgl_a']."' and '".$_POST['tgl_b']."' and '".$_POST['hotel']."' and idclass='".$_POST['rooms']."'"); 
//		$rc=mysql_num_rows($q); 
//		if($rc==0) { 
