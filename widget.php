  ...
  theme : 'custom',
    custom_theme_widget: 'recaptcha_widget'
		...
		<form action="#" method="post" id="myform">
            ...
            <label>Hotel</label>
				<select name="hotel" class="required" id="selectBox">
...
if(isset($_POST['button']))
{
	...
	$q=mysql_query("Select * from reservations Where resv_date between '".$_POST['checkin']."' and '".$_POST['checkout']."' and '".$_POST['provinsi']."' and idhotel='".$_POST['hotel']."' and idclass='".$_POST['rooms']."'");
	$rc=mysql_num_rows($q);
	if($rc==0)
	{
