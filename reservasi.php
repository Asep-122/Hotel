...
echo $pr1['title'];
?></h1>
<h2>Total <?php echo number_format($_SESSION['interval']*$hrg,2); ?></h2>
...
<input type="text" name="pay" placeholder="Masukan No Rekening Anda">
<!--<a href="pages/web/cetakpdf.php"><input type="submit" name="button" value="Booking"/></a>-->
...
{
	/*
	$q=mysql_query("INSERT INTO `myhotel`.`reservations` 
		(`resv_date`,`resv_date2`,`alamat`,`no_telp`,
		`email`,`title`, `name`, 
		`identify_kinds`, `identify_value`, `payment_kinds`, `payment_value`, `idclass`) 
		VALUES ( '".$_SESSION['tgl1']."', '".$_SESSION['tgl2']."', '".$_POST['alamat']."', '".$_POST['notelp']."', 
		'".$_POST['email']."', '".$_POST['title']."', '".$_POST['nama']."', 
		'".$_POST['identitas']."', '".$_POST['iden']."', '".$_POST['payment']."', '".$_POST['pay']."', '".$_SESSION['rm']."')");
	*/
		echo "<script>
		window.open('pages/web/cetak.php');
		</script>";
