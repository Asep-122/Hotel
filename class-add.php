...
<form name="form1" method="post" action="">
 <label>Hotel</label>
				<select name="hotel" class="required" id="selectBox" onChange="changeFunc()">
                    
					<option value="">- please select -</option>
                    <?php
					$q=mysql_query("Select * from hotel");
					while($r=mysql_fetch_array($q))
					{
					?>
					<option value="<?php echo $r['id_hotel']; ?>"><?php echo $r['nama_hotel']; ?></option>
                    <?php
					}
					?>
				</select>
...
<input type="checkbox" value="Kolam" name="9">Kolam Renang<br>
<p></p>
...
if(isset($_POST["button"]))
{
	...
	$rs=mysql_query("INSERT INTO `myhotel`.`class` (`id_hotel`, `title`, `price`, `description`, `photoclass`) VALUES ('".$_POST['hotel']."','".$_POST['title']."','".$_POST['harga']."', '".$_POST['editor1']."','".$_POST['photo']."')");
	...
	{	
		...
		if($fc8)
		{
		$sql8="Insert into facilities values ('".$nid."','".$fc9."','Kolam Renang Pribadi','1')";
		}else{
		$sql8="Insert into facilities values ('".$nid."','Kolam','Kolam Renang Pribadi','0')";
		}
		$a1=mysql_query($sql1);
		$a2=mysql_query($sql2);
		$a3=mysql_query($sql3);
